window.ConfettiGenerator = function(e) {
  ...
  e &&
    ...
    void 0 !== e.rotate && null !== e.rotate && (t.rotate = e.rotate))
  ...
  function l(e) {
    var r = e.radius <= 3 ? 0.4 : 0.8
    switch (
      ((a.fillStyle = a.strokeStyle = 'rgba(' + e.color + ', ' + r + ')'),
      a.beginPath(),
      e.prop)
    ) {
      case 'circle':
      ...
      return requestAnimationFrame(function e() {
        ...
        !(function() {
          for (var e = 0; e < t.max; e++) {
            var r = i[e]
            t.animate && (r.y += r.speed),
              r.rotate && (r.rotation += r.speed / 35),
              ((r.speed >= 0 && r.y > t.height) || (r.speed < 0 && r.y < 0)) &&
                ((i[e] = r),
                (i[e].x = o(t.width, !0)),
                (i[e].y = r.speed >= 0 ? -10 : parseFloat(t.height)))
          }
        })(),
